...
final case class UnionOfNullWithTwoNonNullTypes(var r5: Option[Either[Int, String]]) extends org.apache.avro.specific.SpecificRecordBase {
  def this() = this(None)
  ...
  def put(field$: Int, value: Any): Unit = {
    (field$: @switch) match {
      ...
      }.asInstanceOf[Option[Either[Int, String]]]
      case _ => new org.apache.avro.AvroRuntimeException("Bad index")
    }
    ()
  }
...
object UnionOfNullWithTwoNonNullTypes {
  ...
  object types {
    type r5 = Option[Either[Int, String]]
  }
}